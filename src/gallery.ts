...
export function next(currentLinks: Gallery["links"]): Promise<Gallery> {
    ...
    return loadResource<Gallery>("https://webetu.iutnc.univ-lorraine.fr" +currentLinks.next.href);
}
...
export function prev(currentLinks: Gallery["links"]): Promise<Gallery> {
    ...
    return loadResource<Gallery>("https://webetu.iutnc.univ-lorraine.fr" +currentLinks.prev.href);
}
...
export function first(currentLinks: Gallery["links"]): Promise<Gallery> {
    ...
    return loadResource<Gallery>("https://webetu.iutnc.univ-lorraine.fr" +currentLinks.first.href);
}
...
export function last(currentLinks: Gallery["links"]): Promise<Gallery> {
    ...
    return loadResource<Gallery>("https://webetu.iutnc.univ-lorraine.fr" +currentLinks.last.href);
}